...
const subjects = {
  en: {
    ...
    "boundary.place": "Place boundary", "boundary.zone": "Zone", "boundary.custom": "Other boundary",
  ...
  pl: {
    ...
    "boundary.place": "Granica lokalizacji", "boundary.zone": "Strefa", "boundary.custom": "Inna granica",
...
export const toolboxCopy: Record<Locale, ToolboxCopy> = {
  en: {
    ...
    instruments: { select: "Select & edit", marquee: "Select an area", place: "Place", pencil: "Pencil", pen: "Bezier pen", line: "Straight line", "wall-run": "Wall run", rectangle: "Rectangle", circle: "Circle", ellipse: "Ellipse", arc: "Three-point arc", polygon: "Polygon", point: "Point", note: "Write note", erase: "Eraser" },
  ...
  pl: {
    ...
    instruments: { select: "Zaznacz i edytuj", marquee: "Zaznacz obszarem", place: "Wstaw", pencil: "Ołówek", pen: "Pióro Béziera", line: "Prosta", "wall-run": "Ciąg ścian", rectangle: "Prostokąt", circle: "Okrąg", ellipse: "Elipsa", arc: "Łuk trzy-punktowy", polygon: "Wielokąt", point: "Punkt", note: "Napisz notatkę", erase: "Gumka" },
