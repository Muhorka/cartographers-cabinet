...
export const checkpointCopy: Record<EditorLocale, CheckpointCopy> = {
  pl: {
    ...
    explanation: "Zachowaj wybrany stan projektu, żeby móc do niego wrócić albo porównać go z obecną wersją. Zapisany stan możesz przywrócić lub nałożyć na aktualny arkusz jako kalkę.",
  ...
  en: {
    ...
    explanation: "Save a chosen state of the project so you can return to it or compare it with the current version. You can restore the saved state or overlay it on the current sheet as a tracing.",
