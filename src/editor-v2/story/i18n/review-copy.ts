...
export const reviewCopy = {
  pl: {
    title: "Sprawdź założenia sceny", intro: "Uruchom kontrolę zapisanych intencji dla wybranych obiektów lub całego projektu. Gabinet pokaże wynik, wykorzystane dane i ewentualne braki bez zmieniania samego założenia.",
    ...
    proof: { permission: "Sprawdza, czy dana postać lub grupa ma prawo wejść do wskazanego miejsca. Fizyczną możliwość dotarcia do niego ocenia osobno trasa.", "single-route": "Wynik dotyczy tej konkretnej obliczonej drogi. Inna trasa może prowadzić inaczej i dać inny rezultat.", author: "Tego założenia Gabinet nie może rozstrzygnąć automatycznie. Ostateczną ocenę pozostawia Tobie." },
    conditions: "Warunki", missing: "Brakujące fakty", sources: "Fakty i źródła", local: "Notatki autora", conflicts: "Sprzeczne wartości", source: "Źródło", focus: "Pokaż obiekt", distance: "Długość trasy", sourceLimit: "Lista źródeł została ograniczona; pełne dane pozostają w projekcie.", physicalOpen: "Fizycznie otwarte", physicalClosed: "Fizycznie zamknięte", diagnostic: "Szczegóły obliczenia", freshRoute: "Oblicz trasę ponownie w aktualnym stanie świata lub scenariusza. Dzięki temu wynik uwzględni zmiany wprowadzone od czasu poprzedniego zapisu.",
  ...
  en: {
    title: "Check scene intentions", intro: "Run a check on saved intentions for selected objects or the entire project. The Cabinet shows the result, the data used, and any missing information without changing the assumption itself.",
    ...
    proof: { permission: "Checks whether a character or group has permission to enter the selected place. A route assesses separately whether the place can be reached physically.", "single-route": "The result applies to this particular calculated path. Another route may take a different course and produce a different result.", author: "The Cabinet cannot resolve this assumption automatically. The final assessment is yours." },
    conditions: "Conditions", missing: "Missing facts", sources: "Facts and sources", local: "Author notes", conflicts: "Conflicting values", source: "Source", focus: "Show object", distance: "Route length", sourceLimit: "The source list was limited; full records remain in the project.", physicalOpen: "Physically open", physicalClosed: "Physically closed", diagnostic: "Calculation details", freshRoute: "Recalculate the route in the current world or scenario state so the result reflects changes made since it was last saved.",
