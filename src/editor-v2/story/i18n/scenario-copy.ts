...
export const scenarioCopy: Record<StoryLocale, ScenarioCopy> = {
  pl: {
    ...
    descriptionHint: "Nazwij sytuację i opisz jej sens. Zmiany zapisują się automatycznie.",
  ...
  en: {
    ...
    descriptionHint: "Name the situation and explain its purpose. Changes save automatically.",
