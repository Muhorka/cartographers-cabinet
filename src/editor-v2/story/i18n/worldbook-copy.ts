...
const worldbookCommonCopy = {
  pl: {
    ...
    relationHint: "Wybierz, kto lub co jest podmiotem i wobec kogo lub czego zachodzi relacja. Nazwa, opis i źródło są opcjonalne.", intentionHint: "Opisz zamysł i wybierz obiekt, którego dotyczy.",
  ...
  en: {
    ...
    creationHint: "Only a name is required. Add other details later.", relationHint: "Choose who or what is involved on each side. A name, description and source are optional.", intentionHint: "Describe your intent and select its subject.",
