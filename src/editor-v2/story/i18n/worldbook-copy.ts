...
const pl: Partial<Record<StoryCollection, EntryCopy>> = {
  characters: { add: "Dodaj postać", create: "Utwórz postać", name: "Imię lub nazwa postaci", hint: "Twórz karty postaci występujących w świecie. Możesz opisać ich cechy, przynależność, wiedzę, klucze i inne informacje używane później w Opowieści." },
  ...
  relations: { add: "Dodaj relację", create: "Utwórz relację", name: "Nazwa relacji", hint: "Zapisuj związki między postaciami, organizacjami, miejscami i obiektami — np. kto czego używa, czego strzeże albo co odwiedza. Relacje pomagają opisywać świat i dają agentowi dodatkowy kontekst. Zasady dostępu, własności i wiedzy ustawiasz osobno." },
...
const en: Partial<Record<StoryCollection, EntryCopy>> = {
  characters: { add: "Add character", create: "Create character", name: "Character name", hint: "Create profiles for characters who appear in the world. You can describe their traits, affiliations, knowledge, keys, and other information used later in the Story." },
  ...
  relations: { add: "Add relation", create: "Create relation", name: "Relation name", hint: "Record connections between characters, organizations, places, and objects, such as who uses, guards, or visits something. Relations help describe the world and give the agent more context. Set access, ownership, and knowledge rules separately." },
...
const worldbookCommonCopy = {
  pl: {
    ...
    knowledge: "O kim lub o czym wie „{name}”?", knowledgeHint: "Zapisz, jakie postacie, organizacje lub inne wpisy świata zna ta postać albo frakcja. To ogólna wiedza o świecie; znajomość tajnego przejścia ustawiasz osobno przy samym przejściu.",
  ...
  en: {
    ...
    knowledge: "Who or what does “{name}” know about?", knowledgeHint: "Record which characters, organizations, or other world entries this character or faction knows. This is general knowledge about the world; knowledge of a secret passage is set separately on the passage itself.",
