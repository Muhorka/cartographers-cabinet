...
const en: IntentionCopy = {
  ...
  actorNeeded: "Choose a character, faction, or access group. Keys do not grant permission by themselves.",
  noObjects: "No map objects are available.",
  noZones: "No authored zones are available.",
  noActors: "No characters, factions, or access groups are available.",
...
const pl: IntentionCopy = {
  ...
  actorNeeded: "Wybierz postać, frakcję albo grupę dostępu. Sam klucz nie nadaje uprawnienia.",
  noObjects: "Brak dostępnych obiektów mapy.",
  noZones: "Brak zapisanych stref.",
  noActors: "Brak postaci, frakcji i grup dostępu.",
