...
export function PlaceShape({ place, mode, prefix, transform, labelPlan, labelScope = "", selectionLayer, selectable = false, allowLockedSelection = false, viewportZoom = 1, resizeHandleSize = 5, showResizeHandles = false, selected, agentFocused, showArea = false, units = "metric", onSelect, onOpen }: { place: PlaceNode; mode: "active" | "child" | "context" | "descendant"; prefix: string; transform?: string; labelPlan?: LabelLayoutPlan; labelScope?: string; selectionLayer?: WorkLayerId; selectable?: boolean; allowLockedSelection?: boolean; viewportZoom?: number; resizeHandleSize?: number; showResizeHandles?: boolean; selected?: boolean; agentFocused?: boolean; showArea?: boolean; units?: "metric" | "imperial"; onSelect?(additive?: boolean): void; onOpen?(): void }) {
