...
export function EditorWorkbench() {
  ...
  const story = useWorkbenchStory({ session, snapshot, selections, inspectedPlaceId, locale, mode, refresh: () => refresh(), zoom: viewport.zoom, onSelect: selectOnMap, onOpenPlace: commitOpenPlace, onFocus: createStoryObjectFocus(() => session?.getViewState(), commitOpenPlace, setSelections), onOpenWorldbook: () => drawing.requestAfterDraft(() => requestAfterOverlap(enterStory)) });
